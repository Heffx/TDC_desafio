...
<head>
    ...
    <title>{{ config('app.name', 'TDC') }}</title>
...
<body>
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto mx-5">
                        ...
                        @if(\Illuminate\Support\Facades\Auth::user()->type_user == 'Admin')
                            ...
                            @endif
                            @if(\Illuminate\Support\Facades\Auth::user()->type_user == 'User')
                                <li class="nav-item">
        ...
        <footer class="card-footer fixed-bottom text-sm-center text-light bg-dark">
            TDC - 2020
        </footer>
        <div class="my-5">
            <!--Space Footer-->
